...
class FlutterSerialPort {
  ...
  static Future<List<Device>> listDevices() async {
    List devices =
        await (_channel.invokeMethod("getAllDevices")) as List<Object?>;
...
class SerialPort {
  ...
  Future<bool> open() async {
    bool openResult = await (_channel.invokeMethod(
        "open", {'devicePath': device.path, 'baudrate': baudrate})) as bool;
  ...
  Future<bool> close() async {
    bool closeResult = await (_channel.invokeMethod("close")) as bool;
